...
@set MYBINARY=zlib
@set MYSOURCE=adler32.c compress.c crc32.c deflate.c gzclose.c gzlib.c gzread.c gzwrite.c infback.c inffast.c inflate.c inftrees.c trees.c uncompr.c zutil.c
@set MYCL=cl /nologo /c /W3 /arch:SSE2 /fp:fast /GR- /TC /I. /DWIN32 /D_CRT_SECURE_NO_WARNINGS /D_CRT_NONSTDC_NO_WARNINGS /D_BIND_TO_CURRENT_CRT_VERSION
