...
@set MYCL=cl /nologo /c /W3 /arch:SSE2 /fp:fast /GR- /TC /wd4146 /wd4244 /I. /I../../pixman/src /I../../freetype/src /I../../zlib/src /I../../libpng/src /DWIN32 /DCAIRO_WIN32_STATIC_BUILD /D_CRT_SECURE_NO_WARNINGS /D_CRT_NONSTDC_NO_WARNINGS /D_BIND_TO_CURRENT_CRT_VERSION
