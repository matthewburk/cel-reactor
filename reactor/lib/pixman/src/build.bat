...
@set MYBINARY=pixman
@set MYSOURCE=pixman-access.c pixman-access-accessors.c pixman-bits-image.c pixman-combine32.c pixman-combine64.c pixman-conical-gradient.c pixman-cpu.c pixman-edge.c pixman-edge-accessors.c pixman-fast-path.c pixman-general.c pixman-gradient-walker.c pixman-image.c pixman-implementation.c pixman-linear-gradient.c pixman-matrix.c pixman-noop.c pixman-radial-gradient.c pixman-region16.c pixman-region32.c pixman-solid-fill.c pixman-sse2.c pixman-timer.c pixman-trap.c pixman-utils.c pixman.c
@set MYCL=cl /nologo /c /W3 /arch:SSE2 /fp:fast /GR- /TC /wd4244 /I. /DWIN32 /DHAVE_CONFIG_H /DUSE_SSE2 /D_CRT_SECURE_NO_WARNINGS /D_CRT_NONSTDC_NO_WARNINGS /D_BIND_TO_CURRENT_CRT_VERSION
